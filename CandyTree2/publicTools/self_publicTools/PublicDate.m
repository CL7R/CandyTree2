...
+(NSDate *)timeZone:(NSDate *)fromDate{
    NSTimeZone *zone = [NSTimeZone systemTimeZone];
    NSInteger interval = [zone secondsFromGMTForDate: fromDate];
    return [fromDate  dateByAddingTimeInterval: interval];
}
+(NSDateComponents *)calculationDateTime:(NSString *)paramDateTime{        
    ...
    NSDate *fromDate =[PublicDate timeZone:[dateFormat dateFromString:paramDateTime]];
    //获取当前日期
    NSDate* toDate = [PublicDate timeZone:[NSDate date]];
