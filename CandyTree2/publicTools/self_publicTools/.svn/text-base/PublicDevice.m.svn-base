...
+(NSString *)getDeviceInfo{
    ...
    NSString *strDevice=[[[NSString alloc]initWithFormat:@"{\"deviceName\":\"%@\",\"systemName\":\"%@\",\"systemVersion\":\"%@\",\"model\":\"%@\",\"appType\":\"%d\"}",[mydevice name],[mydevice systemName],[mydevice systemVersion],[mydevice model],3]autorelease];
    return strDevice;
}
//是否是itouch
+(BOOL)isIPod{
